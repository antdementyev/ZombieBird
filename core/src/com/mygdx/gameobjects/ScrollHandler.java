...
public class ScrollHandler {
    ...
    public static final int SCROLL_SPEED = -59; // как быстро на перемещать объекты
    ...
    public void update(float delta) {
        ...
        // проверяем кто из объектов за левой границей и сбрасываем параметры этого объекта
