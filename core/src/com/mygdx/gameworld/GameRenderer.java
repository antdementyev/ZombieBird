...
public class GameRenderer {
    ...
    private SpriteBatch batcher; // отрисовывает картинки
    ...
    public void render(float runTime) { // аргумент необходим, чтобы определить какой фрейм из анимации птички нам следует отобразить.
        ...
        batcher.begin();
        // Отменим прозрачность. Это хорошо для производительности, когда отрисовываем картинки без прозрачности
        ...
        if (myWorld.isReady()) {
            AssetLoader.shadow.draw(batcher, "Touch me", (136 / 2)- (42), 76);// Отрисуем сначала тень
            AssetLoader.font.draw(batcher, "Touch me", (136 / 2)- (42 - 1), 75); // Отрисуем сам текст
        } else {
